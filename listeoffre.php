...
// Récupération des offres de stage auxquelles l'étudiant a postulé
$nom = "Dupont";
$prenom = "Jean";
$sql = "SELECT * FROM offre_stage JOIN postuler ON offre_stage.id_offre = postuler.id_offre WHERE postuler.nom = :nom AND postuler.prenom = :prenom";
...
<div class="container2">
			<nav>
				...
				<li class="nav-item"><a href="home.php" class="nav-link">ACCEUIL</a></li>
					...
					<li class="nav-item"><a href="test1.php" class="nav-link">postuler</a></li>
					<li class="nav-item">
    ...
    <tr>
        ...
        <?php
          ...
          foreach ($resultats as $resultat) {
              ...
              echo "<td>" . $resultat['titre_offre'] . "</td>";
              echo "<td>" . $resultat['entreprise'] . "</td>";
              echo "<td>" . $resultat['description_offre'] . "</td>";
              echo "<td>" . $resultat['duree_stage'] . "</td>";
              echo "<td>" . $resultat['remuneration'] . "</td>";
              echo "</tr>";
          }
