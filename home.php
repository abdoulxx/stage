...
<div class="container2">
			<nav>
				...
				<li class="nav-item"><a href="home.php" class="nav-link">ACCEUIL</a></li>
					<li class="nav-item"><a href="offre.php" class="nav-link">offre</a></li>
					<li class="nav-item"><a href="listeoffre.php" class="nav-link">LISTE DES OFFRES</a></li>
					<li class="nav-item">
			...
			<h1>LISTE DES OFFRES</h1> <br> <hr> <br>
<table>
    <tr>
        <th>Titre offre</th>
        <th>Description</th>
    ...
    ?>
        <tr>
            ...
            <td><?php echo $affiche["description_offre"]; ?></td>
            <td><?php echo $affiche["date_offre"]; ?></td>
            <td><?php echo $affiche["duree_stage"]; ?></td>
            <td><?php echo $affiche["remuneration"]; ?></td>
            <td><?php echo $affiche["entreprise"]; ?></td>
            <td>
               <a href="postuler.php"> <button  style="background-color: green; color: white;">Postuler</button> </a>
            </td>
        </tr>
    <?php
...
.container2 {
	...
	width: 100%;
	padding: 0 8%;
	background: linear-gradient(rgba(0, 0, 0, 0.4), transparent), url('etudiant.jpg') center center no-repeat;
