...
<html lang="en">
	...
	<body>
		<div class="container">
			...
			<div class="card">
		<h2> continuer en tant que :</h2>
		<a href="login.php" ><button class="btn">Etudiants</button></a>
		<a href="loginE.php" ><button class="btn">Enseingnants</button></a>
		<a href="loginD.php" ><button class="btn">Departement</button></a>
		<a href="loginu.php" ><button class="btn">Entreprise</button></a>
	</div>
